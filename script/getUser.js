...
function checkToken() {
  if (localStorage.getItem("userToken")) {
    fetch(`${url}/user/get-all-user`, {
      ...
      <td data-label="Blood Group"><i class="fas fa-tint"></i> ${item.blood_group}</td><td data-label="City"><i class="fas fa-map-marker"></i> ${item.city}</td><td data-label="Action"><button class="btn btn-primary btn-lg contact"  onClick="openModal()">contact</button></td>`;
